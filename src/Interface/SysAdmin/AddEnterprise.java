...
public class AddEnterprise extends javax.swing.JPanel {
    ...
    public AddEnterprise(JPanel userProcessContainer,Network network ,EnterpriseType type) {
        initComponents();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        for(Enterprise enterprisehere : network.getEnterpriseDirectory().getEnterpriseList()){
            if(enterprisehere.getName().equals(name)){
                JOptionPane.showMessageDialog(null, "You have already created this Enterprise!");
                return;
            }
        }
