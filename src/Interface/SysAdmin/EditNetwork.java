...
public class EditNetwork extends javax.swing.JPanel {
    ...
    Network network;
    public EditNetwork(JPanel userProcessContainer,Network network) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.network = network;
        nameJTextField.setText(network.getNetworkName());
        addressJTextField2.setText(network.getAddress().getAddress());
        cityjTextField3.setText(network.getAddress().getCity());
        statejTextField4.setText(network.getAddress().getState());
        countryjTextField5.setText(network.getAddress().getCountry());
        zipcodejTextField6.setText(network.getAddress().getZipcode());
        contactjTextField7.setText(network.getAddress().getContactNumber());
    }
