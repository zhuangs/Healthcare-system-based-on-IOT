...
public class AddOrganization extends javax.swing.JPanel {
    ...
    public AddOrganization(JPanel userProcessContainer,Enterprise enterprise ) {
        initComponents();
    ...
    public void populateCombo(){
        ...
        typeJCombo.addItem(Organization.OrganizationType.PHDOrganization);
        typeJCombo.addItem(Organization.OrganizationType.DistributorOrganization);
    }
    /**
    ...
    private void initComponents() {
        ...
        populationjSpinner2 = new javax.swing.JSpinner();
        ...
        typeJCombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                typeJComboActionPerformed(evt);
            }
        });
        ...
        populationjSpinner2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addComponent(populationjSpinner2, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE))))))))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(populationjSpinner2, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(OrganizationType.DistributorOrganization.getValue().equals(type.getValue())){
            for(Organization or : enterprise.getOrganizationDirectory().getOrganizationList()){
                if(or instanceof DistributorOrganization){
                    JOptionPane.showMessageDialog(null,"You Can have only one Distributor!");
                    return;
                }
        ...
        int population = (int) populationjSpinner2.getValue();
       ...
       if (organization instanceof PHDOrganization){
           ((PHDOrganization)organization).setPopulation(population);
       }
    ...
    private void typeJComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_typeJComboActionPerformed
        // TODO add your handling code here:
        if(typeJCombo.getSelectedItem() != null){
                if(((Organization.OrganizationType)typeJCombo.getSelectedItem()).getValue().equals(Organization.OrganizationType.PHDOrganization.getValue())){
                populationjSpinner2.setEnabled(true);
            }
            else{
                populationjSpinner2.setEnabled(false);
               }
        }
        
        
        
    }//GEN-LAST:event_typeJComboActionPerformed
    ...
    private javax.swing.JSpinner populationjSpinner2;
