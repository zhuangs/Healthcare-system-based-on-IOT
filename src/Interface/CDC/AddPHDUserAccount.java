 ...
 * @author yufeng
 */
public class AddPHDUserAccount extends javax.swing.JPanel {

    /**
     * Creates new form AddPHDUserAccount
     */
    JPanel userProcessContainer;
    Organization organization;
    private String gender;
    public AddPHDUserAccount(JPanel userProcessContainer,Organization organization) {
        initComponents();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        UserAccount userAccount = organization.getUserAccountDirectory().addUserAccount();
        ...
        if(organization instanceof PHDOrganization){
            userAccount.setRole(new PHDRole());
        }
        else if(organization instanceof DistributorOrganization){
            userAccount.setRole(new DistributorRole());
        }
